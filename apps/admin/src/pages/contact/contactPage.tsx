  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      >
        ...
        {/* Table + Pagination inside a single card, like Page */}
        <motion.div
        ...
        >
          <div className="p-6 overflow-x-auto">
            <table className="rounded-xl border border-gray-200 shadow-lg overflow-hidden w-full text-sm text-center">
                  ...
                  {isLoading ? (
                    ...
                    contacts.map((contact, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-left font-medium whitespace-nowrap">{contact.name}</td>
                        <td className="px-4 py-3">
                          <div className="flex items-center justify-center gap-2">
                            <Mail size={16} className="text-blue-900" />
                            <a href={`mailto:${contact.email}`} className="text-black whitespace-nowrap !no-underline">
                              {contact.email}
                            </a>
                          </div>
                        </td>
                        <td className="px-4 py-3">
                          <div className="flex items-center justify-center gap-2">
                            ...
                            <a href={`tel:${contact.mobile}`} className="text-black whitespace-nowrap !no-underline">
                              {contact.mobile}
                            </a>
                          </div>
                        </td>
          ...
          {/* Pagination inside with border, like Page */}
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      {/* Modal open/close animation updated to match smooth open/close */}
      <AnimatePresence>
        {showMessageModal && selectedContact && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[80vh] overflow-y-auto border border-gray-200"
            >
              ...
              <div className="p-6 space-y-5 text-sm sm:text-base bg-[#f5f5f5]">
                <div>
                  ...
                  <div className="bg-white p-4 rounded-lg border border-gray-200">{selectedContact.name}</div>
                </div>
                <div>
                  <label className="block text-gray-600 font-medium mb-1">Email</label>
                  <div className="bg-white p-4 rounded-lg border border-gray-200">{selectedContact.email}</div>
                </div>
                <div>
                  <label className="block text-gray-600 font-medium mb-1">Mobile</label>
                  <div className="bg-white p-4 rounded-lg border border-gray-200">{selectedContact.mobile}</div>
                </div>
                <div>
