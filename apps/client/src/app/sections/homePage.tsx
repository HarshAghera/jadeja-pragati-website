  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-3xl 2xl:max-w-6xl px-5 sm:px-6 md:px-8 lg:px-16 xl:px-20 2xl:px-20 relative z-30 pt-29 sm:pt-16 md:pt-20 lg:pt-24 2xl:pt-28">
        <div>
          <motion.h1
            className="heading text-[#0f2557] text-3xl sm:text-4xl md:text-5xl lg:text-5xl 2xl:text-6xl leading-tight mb-12 sm:mb-12 lg:mb-12 xl:mb-12"
          ...
          <motion.p
            className="para text-md sm:text-base md:text-lg lg:text-xl xl:text-xl 2xl:text-xl max-w-2xl text-[#0f2557]/90"
