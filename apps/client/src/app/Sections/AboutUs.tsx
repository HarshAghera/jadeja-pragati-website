...
const Aboutus = () => {
  ...
  return (
    <section className="relative overflow-hidden py-20 md:py-22 lg:py-26 xl:py-35">
      <div
      ...
      <div className="relative z-10 flex flex-col justify-center h-full">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-10 items-center text-white">
          ...
          <div
            className="relative flex justify-center items-center bg-cover bg-center w-full aspect-video rounded-xl overflow-hidden cursor-pointer shadow-lg"
            style={{
